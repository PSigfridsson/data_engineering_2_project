...
consumer = client.subscribe('q2-output', subscription_name='q2-sub', consumer_type=ConsumerType.Shared)
...
while True:
	...
	try:
		...
		print("repo_commit_count_tuple: ", input_tuple)

		key = {'repo': input_tuple[0]}
